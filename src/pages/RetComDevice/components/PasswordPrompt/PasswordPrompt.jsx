...
import { RETCOM_PASSWORD_ATTEMPTS_KEY } from '@utils/localStorage';
...
const loadAttempts = () => {
  try {
    const saved = localStorage.getItem(RETCOM_PASSWORD_ATTEMPTS_KEY);
...
const saveAttempt = (command, attempt) => {
  try {
    ...
    localStorage.setItem(RETCOM_PASSWORD_ATTEMPTS_KEY, JSON.stringify(updated));
